...
<img src="https://github.com/blackosx/BsxDarkFenceYellowOrange1/blob/main/preview_ui.jpg" alt="theme_preview" border="0">

<img src="https://github.com/blackosx/BsxDarkFenceYellowOrange1/blob/main/preview_password.jpg" alt="theme_preview" border="0">
...
**Using this theme**<br>
This repository contains a Blackosx directory with a sub-directory BsxDarkFenceYellowOrange1 which contains all necessary ICNS files for the theme.
...
- then just add the BsxDarkFenceYellowOrange1 directory

Either way, for this theme you will want to end up having
EFI/OC/Resources/Image/Blackosx/BsxDarkFenceYellowOrange1

You can switch the icon set used by OpenCanopy by changing the 'PickerVariant' key in OpenCore's config.plist to match the vendor and theme name of the icon set you want to display. So to instruct OpenCanopy to use this icon set you want to set the PickerVariant key to Blackosx\BsxDarkFenceYellowOrange1

```
                <key>PickerVariant</key>
                <string>Blackosx\BsxDarkFenceYellowOrange1</string>
```
